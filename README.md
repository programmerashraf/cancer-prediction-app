...
A live version of the application can be found on [Streamlit Community Cloud]([(https://cancer-prediction-script.streamlit.app/)](https://cancer-prediction-script.streamlit.app/). 
